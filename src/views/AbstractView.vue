...
// Data
import { abstractImages } from '../config/images'
...
const paginatedItems = computed(() => {
  ...
  return abstractImages.slice(start, end)
})

// Calculate total pages
const totalPages = computed(() =>
  Math.ceil(abstractImages.length / itemsPerPage)
)
...
<template>
  <div class="abstract-view">
    ...
    <p class="image-count">Showing {{ paginatedItems.length }} of {{ abstractImages.length }} images</p>
